...
<mt-field label="密码" placeholder="请输入6-10位的密码" type="password"  v-model="password" ref="password"></mt-field>
      ...
      getCode(){
          ...
          if(!partten.test(this.username)){
            Toast({
                ...
                api.user.getCode(this.username,'a!1').then(res=>{
          ...
          if(usernamepartten.test(this.username)){
            ...
            if (passpartten.test(this.password)) {
                ...
                if (this.usercode==this.smscode) {
                    ...
                    api.user.regist(this.username,this.password,this.smscode).then(res=>{
